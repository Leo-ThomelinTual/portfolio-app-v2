...
const Navbar = () => {
  return (
    <nav className="transition-h-border ease group/gap fixed inset-x-1/2 bottom-2 z-50 flex h-17 w-full -translate-x-1/2 justify-center overflow-hidden rounded-full border-0 border-(--color-border-muted) bg-(--background-transparency) shadow-[inset_0px_0px_10px] shadow-white/15 backdrop-blur-xs transition-shadow duration-400 hover:h-20 hover:border-(--color-border) hover:shadow-white/40 md:w-max md:shadow-[inset_0px_-10px_10px] md:hover:shadow-[inset_0px_0px_10px]">
