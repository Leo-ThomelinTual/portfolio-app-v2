...
const NavbarNew = () => {
  return (
    <nav className="transition-h-border ease group/gap fixed inset-x-1/2 bottom-2 z-50 flex h-17 w-max -translate-x-1/2 justify-center overflow-hidden rounded-full border-2 border-(--color-border-muted) bg-(--background-transparency) shadow-[inset_0px_-10px_10px] shadow-white/20 backdrop-blur-xs duration-400 hover:h-20 hover:border-(--color-border)">
